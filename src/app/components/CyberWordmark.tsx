...
export default function CyberWordmark({ className = "", variant = "hero" }: CyberWordmarkProps) {
  if (variant === "hero") {
    return (
      <motion.div
        className={`hero-wordmark relative z-10 flex w-fit max-w-full flex-col items-center justify-center px-1 sm:px-0 ${className}`}
      ...
      >
        ...
        <motion.span
          className="relative z-10 self-center text-center text-[clamp(2.9rem,17vw,7.5rem)] leading-[0.64] font-black uppercase tracking-[0.08em] text-htr-white sm:text-[clamp(5.1rem,10.6vw,8.2rem)] md:text-[clamp(6.1rem,9.4vw,9rem)] lg:text-[clamp(6.8rem,8.4vw,9.7rem)] xl:text-[clamp(7.4rem,7.9vw,10.5rem)]"
        ...
        <motion.span
          className="relative z-10 -mt-1 self-center text-center text-[clamp(2.9rem,17vw,7.5rem)] leading-[0.36] font-black uppercase tracking-[0.08em] text-htr-white sm:-mt-2 sm:text-[clamp(5.1rem,10.6vw,8.2rem)] md:text-[clamp(6.1rem,9.4vw,9rem)] lg:text-[clamp(6.8rem,8.4vw,9.7rem)] xl:text-[clamp(7.4rem,7.9vw,10.5rem)]"
